...
public enum HttpStatusCode {
    ...
    HTTP_ACCEPTED(202, "已接受"),
    HTTP_NON_AUTHORITATIVE_INFORMATION(203, "非授权信息"),
    HTTP_NO_CONTENT(204, "无内容"),
    HTTP_RESET_CONTENT(205, "重置内容"),
    HTTP_PARTIAL_CONTENT(206, "部分内容"),
    HTTP_MULTIPLE_CHOICES(300, "多种选择"),
    HTTP_MOVED_PERMANENTLY(301, "永久移动"),
    HTTP_FOUND(302, "临时移动"),
    HTTP_SEE_OTHER(303, "查看其它地址"),
    HTTP_NOT_MODIFIED(304, "未修改"),
    HTTP_USE_PROXY(305, "使用代理"),
    HTTP_UNUSED(306, "已经被废弃的HTTP状态码"),
    HTTP_TEMPORARY_REDIRECT(307, "临时重定向"),
    HTTP_BAD_REQUEST(400, "客户端请求的语法错误,服务器无法理解"),
    HTTP_UNAUTHORIZED(401, "请求要求用户的身份认证"),
    HTTP_PAYMENT_REQUIRED(402, "保留"),
    ...
    HTTP_PROXY_AUTHENTICATION_REQUIRED(407, "请求要求代理的身份认证,与401类似,但应使用代理进行授权"),
    HTTP_REQUEST_TIME_OUT(408, "服务器等待客户端发送的请求时间过长,超时"),
    HTTP_CONFLICT(409, "服务器处理请求时发生了冲突"),
    HTTP_GONE(410, "客户端请求的资源已经不存在,该资源在以前有,现在被永久删除了"),
    HTTP_LENGTH_REQUIRED(411, "服务器无法处理客户端发送的不带Content-Length的请求信息"),
    HTTP_PRECONDITION_FAILED(412, "客户端请求信息的先决条件错误"),
    HTTP_REQUEST_ENTITY_TOO_LARGE(413, "由于请求的实体过大,服务器无法处理,因此拒绝请求."),
    ...
    HTTP_SERVICE_UNAVAILABLE(503, "由于超载或系统维护,服务器暂时的无法处理客户端的请求."),
    HTTP_GATEWAY_TIME_OUT(504, "充当网关或代理的服务器,未及时从远端服务器获取请求"),
    HTTP_HTTP_VERSION_NOT_SUPPORTED(505, "服务器不支持请求的HTTP协议的版本,无法完成处理");
    ...
    HttpStatusCode(int code, String describe) {
        this.code = code;
